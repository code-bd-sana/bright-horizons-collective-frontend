...
export function PlanCard({
  ...
  return (
    <div className="relative flex h-[367px] w-[286px] shrink-0 flex-col overflow-hidden rounded-[16px] border border-[var(--border\/500,#d8ddd9)] bg-white p-px shadow-[0px_1px_5px_0px_rgba(23,74,77,0.05)] max-sm:w-full">
      {/* Image Header */}
      <div className="relative h-[132px] w-full shrink-0 overflow-hidden bg-[#e9f1ee]">
        <div
        ...
        >
          <Image src={imageSrc} alt={title} fill sizes="124.396px" className="object-cover" />
        </div>
      </div>

      {/* Content */}
      <div className="flex flex-col gap-[10px] px-[16px] pt-[14px]">
        {/* Tags */}
      ...
      {/* Actions */}
      <div className="mt-[14px] flex w-full items-start gap-[8px] px-[16px] pb-[14px]">
        {status === 'active' && (
          <Link
