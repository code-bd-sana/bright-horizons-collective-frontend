...
export function MaterialsNeeded() {
  const imgStar3 = 'http://localhost:3845/assets/976ed045a8467b3e22f31ee206a6ec1d52447e62.svg';
  const imgStar8 = 'http://localhost:3845/assets/ce12a977d29a168f1d84a53723e6a12deba41f30.svg';
    ...
    <div className="bg-white border border-[#fafafa] drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] rounded-[16px] p-[32px] flex flex-col gap-[24px] w-full">
      ...
      <div className="flex items-center justify-between w-full relative">
        <div className="relative w-[177px] h-[177px] shrink-0 -mr-[6.667px]">
          <div className="absolute inset-0">
            <div className="absolute inset-[2.14%_4.04%_9.5%_4.04%]">
              <img alt="" className="block max-w-none w-full h-full" src={imgStar3} />
            </div>
          </div>
        ...
        <div className="relative w-[177px] h-[177px] shrink-0 -mr-[6.667px]">
          <div className="absolute inset-0">
            <div className="absolute inset-[2.14%_4.04%_9.5%_4.04%]">
              <img alt="" className="block max-w-none w-full h-full" src={imgStar8} />
            </div>
          </div>
