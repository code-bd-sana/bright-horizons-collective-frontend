        ...
        return (
          <li key={label} className="flex min-w-0 flex-1 items-center last:flex-none">
            ...
            >
              ...
              <span
                className={`truncate font-manrope text-[13px] leading-[19.5px] ${active ? 'font-semibold text-[#2f7d7e]' : complete ? 'hidden font-semibold text-[#1c4b4c] sm:inline 2xl:inline' : 'hidden text-[#607d8b] sm:inline 2xl:inline'}`}
              >
                {label}
              </span>
            </div>
