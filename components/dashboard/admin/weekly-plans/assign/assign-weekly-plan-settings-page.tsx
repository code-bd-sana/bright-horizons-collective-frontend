        ...
        <section className="rounded-2xl border border-[#e7eceb] bg-white p-4 shadow-[0_4px_6px_rgba(0,0,0,0.06)] sm:p-6 2xl:p-6">
          ...
          <div className="mt-5 space-y-5">
            <div className="relative">
              ...
              {openCalendar === 'start' ? (
                <div className="absolute left-0 top-[calc(100%+8px)] z-30 w-full max-w-88.5">
            ...
            <section className="flex items-center justify-between gap-4 rounded-[14px] border border-[#e7eceb] bg-[#f4f8f6] p-4">
