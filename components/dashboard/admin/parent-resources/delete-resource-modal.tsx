          ...
          <>
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0 flex-1">
                ...
                <p className="pt-1.5 font-manrope text-sm leading-5.6 text-[#607d8b]">
                  Deleting “{resource.title}” permanently removes it from the platform and database.
            ...
            <div className="flex flex-col-reverse gap-3 pt-2 sm:flex-row sm:justify-end 2xl:flex-row 2xl:justify-end">
              ...
              <button
                ...
                className="w-full rounded-[14px] bg-[#e57373] px-5 py-2.5 font-manrope text-sm font-semibold leading-5 text-white hover:bg-[#d32f2f] sm:w-auto 2xl:w-auto disabled:opacity-50"
              >
