          ...
          <>
            ...
            <div className="flex flex-col-reverse gap-3 border-t border-[#e7eceb] pt-2.25 sm:flex-row sm:justify-end">
              ...
              <button
                ...
                className="w-full rounded-[14px] bg-[#b8860b] px-5 py-2.5 font-manrope text-sm font-semibold leading-5 text-white transition-colors hover:bg-[#9c7109] sm:w-auto"
              >
                Archive
              </button>
            </div>
