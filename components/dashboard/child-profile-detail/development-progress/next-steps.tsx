...
export function NextSteps() {
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6 rounded-2xl border border-[#D2E3DC] bg-[#E9F1EE] p-4 shadow-[0px_1px_2px_rgba(0,0,0,0.05)] sm:p-6 2xl:p-8">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 2xl:grid-cols-3">
        {cards.map((card) => (
          <div
            key={card.id}
            className="flex min-w-0 flex-col overflow-hidden rounded-3xl border border-[#E9F1EE] bg-white transition-shadow hover:shadow-md"
          >
            <div
