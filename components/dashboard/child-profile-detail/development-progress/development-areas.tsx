  ...
  return (
    <div className="flex min-w-0 flex-col gap-5 rounded-2xl border border-[#E8EBE8] bg-transparent p-4 sm:p-6 2xl:p-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <button
          type="button"
          className="flex w-fit items-center gap-1 rounded-full border border-[#D5E5E5] bg-[#D5E5E5] px-3 py-2 font-nunito text-xs font-medium tracking-[0.04em] text-[#174A4D] shadow-[inset_0px_-6px_2px_0px_rgba(255,255,255,0.07)] transition-colors hover:bg-[#c2d6d6]"
        >
          5 Core Growth Areas
        </button>
      </div>
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-start gap-2 rounded-lg border border-[#D5E5E5] bg-[#FAFAFA] p-2">
                <TrendingUp className="mt-0.5 size-4 shrink-0 text-[#7D8488]" />
              ...
              <div className="flex items-start gap-2 rounded-lg border border-[#ECFCCB] bg-[#F7FEE7] p-2">
                <Lightbulb className="mt-0.5 size-4 shrink-0 text-[#7D8488]" />
                <p className="font-nunito text-xs font-medium leading-4 text-[#263238]">
                  OT Home Tip:{' '}
