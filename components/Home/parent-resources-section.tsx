...
const resources: Resource[] = [
  {
    ...
    imageClassName: 'top-[-51px] h-[403px] w-[294px]',
    imageDesktopPosition: 'min-[1600px]:left-[74px]',
  ...
  },
  {
    ...
    imageClassName: 'top-0 h-[290px] w-[273px]',
    imageDesktopPosition: 'min-[1600px]:left-[90px]',
  ...
  },
  {
    ...
    imageClassName: 'top-[-10px] h-[410px] w-[273px]',
    imageDesktopPosition: 'min-[1600px]:left-[88px]',
  ...
  },
  {
    ...
    imageClassName: 'top-[-67px] h-[474px] w-[259px]',
    imageDesktopPosition: 'min-[1600px]:left-[91px]',
...
function ResourceCard({ resource }: { resource: Resource }) {
  return (
    <article className="relative flex h-full min-h-[420px] sm:min-h-[460px] w-full max-w-[422px] flex-col overflow-hidden rounded-3xl border border-[#E9F1EE] bg-white">
      <div className="relative aspect-[422/290] w-full overflow-hidden rounded-3xl bg-[#E0E7FF] shrink-0">
        <div
          className={`absolute left-1/2 -translate-x-1/2 min-[1600px]:translate-x-0 ${resource.imageDesktopPosition} ${resource.imageClassName}`}
          style={{
      ...
      <div className="flex flex-1 flex-col justify-between p-4 sm:p-5 gap-3">
        <div className="flex flex-col gap-2">
          <div className="flex items-start justify-between gap-2">
            <h3 className="font-nunito text-lg sm:text-xl leading-7 font-medium tracking-[-0.2px] text-[#263238]">
              {resource.title}
            </h3>
            <span className="shrink-0 pt-0.5 font-manrope text-xs sm:text-sm leading-[22px] tracking-[-0.084px] text-[#7D8488]">
              {resource.duration}
            </span>
          </div>
        ...
        <Link
          href="/explore"
          className="flex w-fit items-center gap-1 font-manrope text-xs leading-[18px] font-semibold tracking-[0.48px] text-[#2F7D7E] hover:underline pt-2"
        >
          Explore
          <Image
...
function ResourcesHeading() {
  return (
    <header className="flex flex-col items-center text-center px-4">
      ...
      <h2 className="mt-4 w-full max-w-[573px] font-nunito text-[clamp(28px,5vw,48px)] leading-[1.16] font-semibold tracking-[-0.48px] text-[#263238]">
...
function SeeAllLink() {
  return (
    <Link
      href="/explore"
      className="inline-flex min-w-20 items-center justify-center gap-1 rounded-full bg-[#263238] px-4 py-2.5 font-nunito text-base leading-6 font-medium tracking-[-0.176px] text-white hover:bg-[#174A4D] transition-colors"
    >
      See all
...
export function ParentResourcesSection() {
  return (
    <section className="bg-[#FDFDFC]">
      ...
      <div className="mx-auto max-w-290 px-4 py-16 min-[1600px]:hidden sm:px-8 sm:py-24 lg:py-32">
        <ResourcesHeading />
        <div className="mt-10 grid grid-cols-1 justify-items-center gap-6 sm:mt-16 sm:grid-cols-2 sm:gap-8 xl:grid-cols-4">
          {resources.map((resource) => (
            <ResourceCard key={resource.title} resource={resource} />
          ))}
        </div>
