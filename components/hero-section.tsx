...
export function HeroSection({
  ...
  return (
    <section className="relative h-270 min-h-190 overflow-hidden bg-[#FDFDFC] text-[#263238] max-lg:h-auto max-lg:min-h-0">
      <Logo
        width={88}
        height={88}
        showBackdrop
      ...
      <div className="absolute left-1/2 top-140.5 z-20 flex -translate-x-1/2 items-start gap-6 max-lg:relative max-lg:left-auto max-lg:top-auto max-lg:mx-auto max-lg:mt-8 max-lg:w-full max-lg:translate-x-0 max-lg:flex-wrap max-lg:justify-center max-lg:px-5">
        {[
