...
export default function LoginPage() {
  ...
  return (
    <main className="relative h-dvh overflow-hidden bg-[#fffdf8] text-[#263238]">
      ...
      <section className="mx-auto flex w-full max-w-123 flex-col items-center px-6 pt-32 xl:absolute xl:left-[calc(8.333333%+69px)] xl:top-64 xl:mx-0 xl:px-0 xl:pt-0">
